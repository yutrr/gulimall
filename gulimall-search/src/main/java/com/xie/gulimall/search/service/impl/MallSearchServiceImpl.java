...
import com.xie.gulimall.search.feign.ProductFeignService;
import com.xie.gulimall.search.service.MallSearchService;
import com.xie.gulimall.search.vo.AttrResponseVo;
import com.xie.gulimall.search.vo.BrandVo;
    ...
    private SearchResult buildSearchResult(SearchResponse response,SearchParam param) {
        ...
        if (hits.getHits()!=null && hits.getHits().length>0) {
            for (SearchHit hit : hits.getHits()) {
                ...
                SkuEsModel esModel = JSON.parseObject(jsonStr, SkuEsModel.class);
                // 设置高亮信息
