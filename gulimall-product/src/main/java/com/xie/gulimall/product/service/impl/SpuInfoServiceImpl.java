...
import com.xie.common.constant.ProductConstant;
...
import com.xie.gulimall.product.feign.SearchFeignService;
import com.xie.gulimall.product.feign.WareFeignService;
import com.xie.gulimall.product.service.*;
import com.xie.gulimall.product.vo.*;
...
import com.xie.gulimall.product.dao.SpuInfoDao;
    ...
    public void up(Long spuId) {
       ...
       List<SkuInfoEntity> skus= skuInfoService.getSkusBySpuId(spuId);
        ...
        if (r.getCode()==0){
            ...
            /**
             * 1.构造请求数据，将对象转为json
             *  RequestTemplate template=buildTemplateFromArgs.create(argsv);
